...
char *ft_strrncpy (char *dest, const char *src, unsigned int size);
...
char *ft_strsub(const char *s1, unsigned int start, int len);
...
void *ft_memchr(const void *src, int c, unsigned int size);
